    ...
    previous_snapshot = CalculationSnapshot(
        ...
        result_json={
            ...
            "outputs": {
                ...
                "reserve_buffer_cents": 5000,
                "forecast_resources_cents": 115000,
                "goal_gap_cents": 225000,
                "discretionary_capacity_cents": 15000,
                "remaining_weeks": 22,
                "weekly_safe_to_spend_cents": 15000,
                "projected_shortfall_cents": 0,
                "expected_savings_to_date_cents": 75000,
                "pace_status": "On Track",
                "progress_percentage": 25.0,
                "current_week_opening_allowance_cents": 15000,
                "current_week_remainder_cents": 15000,
            },
            "explanation": {

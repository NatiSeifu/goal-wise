...
| **FR-AI-005** | **Future** | If the AI provider is unavailable, times out after 4 seconds, or returns an error, the GoalWise system shall display the deterministic fallback explanation and shall keep every core GoalWise function available. | **Test** |
